<template>
  <div class="side-setting">
    ...
    <setting-item :title="$t('theme.title')">
      ...
      >
        <img-checkbox :title="$t('theme.undertint')"   :img="menuStyle" value="undertint"/>
        <img-checkbox :title="$t('theme.dark')"   :img="menuStyle2" value="dark"/>
        <img-checkbox :title="$t('theme.light')"  :img="menuStyle3" value="light"/>
        <img-checkbox :title="$t('theme.night')"  :img="menuStyle4" value="night"/>
      </img-checkbox-group>
    </setting-item>
...
export default {
  ...
  data() {
    return {
      menuStyle: require('@/assets/menuStyle/menuStyle.svg'),
      menuStyle2: require('@/assets/menuStyle/menuStyle2.svg'),
      menuStyle3: require('@/assets/menuStyle/menuStyle3.svg'),
      menuStyle4: require('@/assets/menuStyle/menuStyle4.svg'),
