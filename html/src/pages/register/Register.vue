          ...
          <a-tab-pane tab="账号注册" key="1">
            ...
            <a-form-item>
              ...
              <a-input
                ...
                placeholder="请确认密码"
                type="password"
                v-decorator="['confirmPassword', {rules: [{ required: true, message: '请确认密码', whitespace: true}]}]"
              >
                <a-icon slot="prefix" type="lock" />
              </a-input>
            </a-form-item>
...
import {register, getRoutesConfig} from '@/services/user'
    ...
    onSubmit (e) {
      ...
      this.form.validateFields((err) => {
        if (!err) {
          ...
          register(username	, password).then(this.afterLogin)
        }
      })
    },
    afterLogin(res) {
